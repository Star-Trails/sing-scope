...
const ru: LANG_MESSAGE = {
  ...
  trafficAndRuleDistribution: 'Распределение трафика и правил',
  processTrafficDistribution: 'Трафик по процессам',
  destinationTrafficDistribution: 'Трафик по адресам',
  byProcess: 'По процессам',
  byDestination: 'По адресам',
  ruleHitDistribution: 'По правилам',
  processes: 'процессов',
  destinations: 'адресов',
