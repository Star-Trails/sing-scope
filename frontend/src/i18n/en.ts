const en = {
  ...
  trafficAndRuleDistribution: 'Traffic & Rule Distribution',
  processTrafficDistribution: 'Process Traffic Distribution',
  destinationTrafficDistribution: 'Destination Traffic Distribution',
  byProcess: 'By Process',
  byDestination: 'By Destination',
  ruleHitDistribution: 'Rule Hit Distribution',
  processes: 'Processes',
