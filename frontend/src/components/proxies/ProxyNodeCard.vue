<template>
  <div
    ...
    :class="
      twMerge(
        'bg-base-200/80 border border-base-content/15 relative flex cursor-pointer flex-col items-start rounded-xl shadow-xs transition-all hover:border-base-content/30 hover:shadow-md',
        active ? 'bg-primary border-primary text-primary-content ring-2 ring-primary/40' : 'sm:hover:bg-base-300/70',
        isSmallCard ? 'gap-1 p-1.5' : 'gap-2 p-2.5',
