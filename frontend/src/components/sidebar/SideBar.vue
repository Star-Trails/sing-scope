<template>
  <div
    ...
    :class="isSidebarCollapsed ? 'w-16 px-1' : 'w-64'"
    @transitionend="handleTransitionEnd"
  >
    <div :class="twMerge('flex h-full flex-col gap-2', isSidebarCollapsed ? 'w-14 px-0' : 'w-60')">
      <div
        ref="navRef"
      ...
      >
        <div
          aria-hidden="true"
          class="sidebar-tab-indicator bg-primary pointer-events-none absolute"
